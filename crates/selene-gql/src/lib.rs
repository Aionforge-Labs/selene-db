...
pub use crate::plan::{
    ...
    LoweredPathSet, MutationOp, NodeIdOrdering, NodeOrEdgeScan, NodeTest, OptimizeContext,
    OrderAccess, OrderKey, OrientationAcceptance, OuterBindingRef, PATH_AUTOMATA_CONTRACT_VERSION,
    PathAutomaton, PathContributor, PathFeatureInventory, PathLoweringLimits, PathModeScope,
    PathSemanticElement, PathSemanticPattern, PathState, PathStateId, PathTransition,
    PathTransitionId, PatternPlan, PipelineOp, PipelineOpId, PlannedCall, PlannedSubquery,
    ...
    RepeatEdgeMatch, Rule, ScanAccess, ScanKind, SelectorScope, SessionOp, SubqueryBody,
    SubqueryKind, SubqueryRegistry, TailBinding, TemporaryBinding, Transformed, TransitionKind,
    TxOp, TypedIndexBounds, TypedIndexLookup, YieldKind, acceptance_for, check_gp18,
    classify_analyzed, classify_plan, explain_automaton, explain_logical, explain_set,
    is_selective_selector, lower_logical, lower_path_automata, lower_path_automata_with_defaults,
    measure_lowering_cost, measure_path_lowering, optimize, plan, supported_path_inventory,
    verify_plan_effects,
};
